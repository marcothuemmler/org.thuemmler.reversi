...
class GameController(
    ...
    @PostMapping
    suspend fun createGame(@RequestBody game: NewGameRequest): Game = service.createGame(game)
    ...
    suspend fun makeMove(@PathVariable id: String, @RequestBody move: MoveRequest): Game {
